...
!0,!1):(new tdcNotice.notice("Content Successfully Saved!",!1,!0),0!==tdcLivePanel.$tdbPostSettings.length&&!0===tdcLivePanel.$tdbPostSettings.data("changed")&&new tdcNotice.notice("Single Templates Post Settings Successfully Saved!",!1,!0)),tdcMain.resetContentModified(),tdcLivePanel.$tdbPostSettings.data("changed",!1))}).fail(function(a,b,e){}))}},saveHistory:function(){if(1!==tdcRecycle._items.length){for(var a=[],c=0;c<tdcRecycle._items.length;c++)a.push({timestamp:tdcRecycle._items[c].timestamp,
description:tdcRecycle._items[c].description,shortcode:tdcUtil.b64EncodeUnicode(tdcRecycle._items[c].shortcode),headerTemplateData:tdcRecycle._items[c].headerTemplateData});tdcLivePanel.$tdcAction.val("tdc_ajax_save_history");tdcLivePanel.$tdcContent.val(tdcUtil.b64EncodeUnicode(JSON.stringify(a)));f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/save_history","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
data:tdcLivePanel.$panel.serialize()}).done(function(a,c,e){"success"===c&&b.isObject(a)&&b.has(a,"errors")&&new tdcNotice.notice(a.errors,!0,!1)}).fail(function(a,c,b){})}},updateHeaderTemplate:function(){var a=tdcSavePost.getHeaderTemplateData();f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/update_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),
tdc_action:"update_header_template",tdc_header_template_id:a.tdc_header_template_id,tdc_header_template_content:a.tdc_header_template_content,tdc_assoc_header_template:a.tdc_assoc_header_template,tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,e,g){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&
(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,b,e){})},getHeaderTemplateData:function(){var a=tdcState.getHeaderTemplateId(),c="",b={};""!==a&&"no_header"!==a&&(c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcIFrameData.getHeaderShortcodeFromData())));tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b.tdc_header_template_id=a;b.tdc_header_template_content=c;b.tdc_assoc_header_template=
tdcState.isGlobalTemplate()?"":!0;return b},cloudLoadHeaderTemplate:function(a,c,e,g){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g},b.isUndefined(e)||(g.tdc_header_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
data:g}).done(function(e,m,g){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"header_template_id")&&(tdcState.setHeaderTemplateId(e.header_template_id),tdcState.unsetGlobalTemplate()),tdcSidebar.updateHeaderTemplates(),tdcIFrameData.setHeaderTemplate(a,c))}).fail(function(a,c,b){}))},saveMobileMenu:function(a,c){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/save_header_mobile_menu","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",
window.tdcAdminSettings.wpRestNonce)},data:{template_id:a,menu_id:c}}).done(function(a,e,d){"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):window.tdcPostSettings.mobileMenuId=c)}).fail(function(a,c,b){})}}})(jQuery,Backbone,_);var tdcShortcodeParser={};
...
var f="";_.isUndefined(d[a].tdc_preset_class)||(f=' class="'+d[a].tdc_preset_class+'"');e+="<li "+c+" "+f+' data-values="'+window.btoa(JSON.stringify(d[a]))+'">'+d[a].tdc_preset_name+"</li>"}e+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return e},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});
...
g)g=window.tdcAdminSettings.globalBlockTemplate;_.isUndefined(g)||_.map(window.tdcAdminSettings.mappedBlockTemplates[g].params,function(a,g){a.param_name===d&&(e=!0,c[d]=b)})}e||0!==d.indexOf("tds_")||(c[d]=b)}),a.set("attrs",c));tdcSidebarController.onUpdate(a)})},addColorpicker:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+
"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-colorpicker-wrap" title="'+(d.heading+'">');a=a+"</div><input "+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackColorPicker);return a},
...
callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-gradient-wrap");if(!_.isUndefined(b.val())&&""!==b.val())try{var e=JSON.parse(window.atob(b.val()));_.isUndefined(e.css)||d.attr("style",e.css)}catch(a){e=b.val(),_.isUndefined(e)||d.attr("style","background: "+e)}})},addDropDown:function(d,b){if("tdb_mobile_menu"===b.get("tag")&&"menu_id"===d.param_name){var e=b.get("attrs");
e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var a=e=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",g=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&g.length<=parseInt(d.tdc_min_options))return c;for(var l=0;l<g.length;l++){var k=!1,h="",n=g[l],p=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),q=String(d.value[g[l]]);_.isObject(d.value[g[l]])&&(k=!0,q=_.values(d.value[g[l]])[0],
n=_.keys(d.value[g[l]])[0]);if(e||a){0===l&&""===p&&(p=q);p===q&&(h=" checked ");p=_.uniqueId();var t=q;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)t="col_"+t;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+p+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+h+' value="'+q+'">';e?(h="",k&&(h="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+h+'" for="'+p+'" title="'+n+'"><div class="'+t+
'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+p+'" title="'+n+'">'+q+"</label>"}else p===q&&(h=' selected="selected" '),f+="<option "+h+' value="'+q+'">'+n+"</option>"}g="";_.has(d,"description")&&""!==d.description&&(g=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+g+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,
b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+f+"</select>");return c+"</div></div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",g=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&g.length<=parseInt(d.tdc_min_options))return c;var l=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var h=JSON.parse(window.atob(k));
l=' data-responsive="'+k+'" ';"undefined"!==typeof h[tdcSidebar.currentViewportSettings.name]&&(k=h[tdcSidebar.currentViewportSettings.name])}catch(r){}for(h=0;h<g.length;h++){var n=!1,p="",q=g[h],t=String(d.value[g[h]]);_.isObject(d.value[g[h]])&&(n=!0,t=_.values(d.value[g[h]])[0],q=_.keys(d.value[g[h]])[0]);if(e||a){0===h&&""===k&&(k=t);k===t&&(p=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;f+='<input class="tdc-property-input-radio" type="radio" '+
tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+t+'">';e?(p="",n&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+u+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+t+"</label>"}else k===t&&(p=' selected="selected" '),f+="<option "+p+' value="'+t+'">'+q+"</option>"}g="";_.has(d,"description")&&""!==d.description&&
(g=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+g+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+l+g+">",c=c+f+"</select>");return c+"</div></div>"},
addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+a+"/>");
return c+"</div></div>"},addCheckBoxResponsive:function(d,b){var e="",a=' data-responsive="" ',c=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var f=JSON.parse(window.atob(c));a=' data-responsive="'+c+'" ';"undefined"!==typeof f[tdcSidebar.currentViewportSettings.name]&&(c=f[tdcSidebar.currentViewportSettings.name])}catch(g){}""!==c&&(e=" checked ");f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+
'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';c=c+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+e+a+"/>");return c+"</div></div>"},addRange:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');
var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var g="";_.has(d,"value")&&""!==d.value&&(g=d.value);var l="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(l=tdcSidebarPanel._getParameterCurrentValue(d,b));var k='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';k+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";
k=k+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+l+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+l+'" />');return k+='<input type="text" class="tdc_range_value" data-default_value="'+g+'" value="'+l+'"/></div></div>'},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+
'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var g="";_.has(d,"value")&&""!==d.value&&(g=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var l="";_.has(d,"placeholder")&&""!==d.placeholder&&(l=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var k=' data-responsive="" ',
h=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var n=JSON.parse(window.atob(h));k=' data-responsive="'+h+'" ';h="undefined"===typeof n[tdcSidebar.currentViewportSettings.name]?"":n[tdcSidebar.currentViewportSettings.name]}catch(p){}n='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';n+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";n=n+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="range" data-value="'+h+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+h+'" '+k+" />");return n+='<input type="text" class="tdc_range_value" data-default_value="'+g+'" '+l+' value="'+h+'"/></div></div>'},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",g="",l=[],k="",h="",n="",p="",q="",t="",v="",
u;for(u in a)a.hasOwnProperty(u)&&(l.push(a[u].unit),""===h||""===k)&&(p=a[u].unit,h=' data-range_unit="'+p+'" ',n=a[u].value,k=' data-range_value="'+n+'" ',q=a[u].range_min,t=a[u].range_max,v=a[u].range_step);if(""!==c){for(var r=[],w=0;w<l.length&&!(r=c.split(l[w]),1<r.length);w++);r.length&&(p=l[w],h=' data-range_unit="'+p+'" ',n=r[0],k=' data-range_value="'+n+'" ')}for(u in a)a.hasOwnProperty(u)&&(c=_.uniqueId(),f+=" data-value_"+u+'="'+a[u].value+'" ',f+=" data-min_"+u+'="'+a[u].range_min+'" ',
f+=" data-max_"+u+'="'+a[u].range_max+'" ',f+=" data-step_"+u+'="'+a[u].range_step+'" ',l=a[u].value,r="",a[u].unit===p&&(l=n,q=a[u].range_min,t=a[u].range_max,v=a[u].range_step,r="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+r+' data-default_value="'+a[u].value+'" data-last_value="'+l+'"/>',g+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+k+" "+h+" "+f+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+n+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+'</div><input type="text" class="tdc_range_value" value="'+(n+'"/>');a+="</div>";a+="</div>";
return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",g="",l=[],k=' data-responsive="" ',h="",n="",p="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(l.push(a[r].unit),""===n||""===h)&&(q=a[r].unit,n=' data-range_unit="'+q+'" ',p=a[r].value,h=' data-range_value="'+p+'" ',t=a[r].range_min,v=a[r].range_max,u=a[r].range_step);
if(""!==c){var w=c;try{var z=JSON.parse(window.atob(c));k=' data-responsive="'+c+'" ';w="undefined"===typeof z[tdcSidebar.currentViewportSettings.name]?"":z[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==w){c=[];for(z=0;z<l.length&&!(c=w.split(l[z]),1<c.length);z++);c.length&&(q=l[z],n=' data-range_unit="'+q+'" ',p=c[0],h=' data-range_value="'+p+'" ')}}for(r in a)a.hasOwnProperty(r)&&(l=_.uniqueId(),f+=" data-value_"+r+'="'+a[r].value+'" ',f+=" data-min_"+r+'="'+a[r].range_min+'" ',f+=
" data-max_"+r+'="'+a[r].range_max+'" ',f+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=p,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+r+'" data-unit_value="'+a[r].unit+'" type="radio" id="'+l+'" '+c+' data-default_value="'+a[r].value+'" data-last_value="'+w+'"/>',g+='<label for="'+l+'">'+a[r].unit+"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+h+" "+n+" "+f+" "+k+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+'</div><input type="text" class="tdc_range_value" value="'+(p+'"/>');a+="</div>";a+=
"</div>";return a+="</div>"},addIconSelector:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+">");a+='</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div></div>';
tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(a,e){var c=jQuery(e);if(d.param_name===c.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==f&&(c.html('<i class="'+f+'"></i>'),c.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button"))}})});return a},addUploadImage:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
...
d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';f+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";f=f+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" '+c+' value="'+
tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');return f=f+a+"</div></div>"},addTextFieldResponsive:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(d,
b);try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';g="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(k){}l='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';l+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+
...
n);h+="</select></div></div>";n=d.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+('<input class="tdc-css-border-color" '+
tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("border-radius","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+c()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+(tdcSidebarPanel._getParamterDataAtts(g,
l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
...
"</select></div></div>";n=tdcCssEditor._getSettingsProperty("opacity","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';h=h+'<div class="tdc-property-title"><span title="Css gradient color From">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+('<input class="tdc-css-color-1-overlay" '+
tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",b,e());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);h+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("z-index","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';h=h+'<div class="tdc-property-title"><span title="Z-index">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",
display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],n);h=h+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' title="Clear all tab css settings">Clear CSS settings</div>');
h+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){f(".tdc-inherit").each(function(a,c){var e=f(c),g=e.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||g.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))e.hide();else{var l=g.data("tdc-for");g={isInherited:!1};l=tdcCssEditor._getSettingsProperty(l,b,g);g.isInherited?e.hide():d.isUndefined(l)||e.show()}})});return h},_getAvailableViewportSetting:function(b,
a,c){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(b){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]&&(d="all");break;case "landscape":case "portrait":case "phone":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]?d=b:"undefined"!==typeof tdcCssEditor._currentCssSettings.all&&(d="all")}if("undefined"!==typeof d){if("undefined"!==typeof tdcCssEditor._currentCssSettings[d][a])return tdcSidebar.currentViewportSettings.name!==d&&(c.isInherited=!0,tdcDebug.log(a)),
tdcCssEditor._cleanCss(a,tdcCssEditor._currentCssSettings[d][a]);if("all"!==d)return tdcCssEditor._getAvailableViewportSetting("all",a,c)}}},_getSettingsPropertyFromCssSettings:function(b,a){var c;if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d=tdcSidebar.currentViewportSettings.name;if("undefined"!==typeof tdcCssEditor._currentCssSettings[d]&&"undefined"!==typeof tdcCssEditor._currentCssSettings[d][b])return tdcSidebar.currentViewportSettings.name!==d&&tdcDebug.log(b),tdcCssEditor._cleanCss(b,
tdcCssEditor._currentCssSettings[d][b])}"undefined"===typeof c&&"undefined"!==typeof a&&(c=a);return c},_getSettingsProperty:function(b,a,c){var d;"undefined"===typeof c&&(c={isInherited:!1});"undefined"!==typeof tdcCssEditor._currentCssSettings&&(d=tdcCssEditor._getAvailableViewportSetting(tdcSidebar.currentViewportSettings.name,b,c));"undefined"===typeof d&&"undefined"!==typeof a&&(d=a);return d},_generateDropdownOptions:function(b,a,c){for(var e=[],f,l=!1,k=0,h=0;h<b.length;h++)d.isUndefined(c)||
c!==b[h].value||(k=h),f="",d.isUndefined(a)||a!==b[h].value||(f='selected="selected"',l=!0),e.push("<option "+f+' value="'+b[h].value+'">'+b[h].display+"</option>");l||(e[k]='<option selected="selected" value="'+b[k].value+'">'+b[k].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),l=b.find(".tdc-css-box-input-margin-left").val().trim(),
k=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),r=b.find(".tdc-css-border-radius").val().trim(),
w=b.find(".tdc-css-width").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),A=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==c&&(a["margin-top"]=c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==l&&(a["margin-left"]=l);""!==k&&(a["border-top-width"]=k);""!==h&&(a["border-right-width"]=
h);""!==n&&(a["border-bottom-width"]=n);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||1!==c||(a["border-color"]="no_value"));
""!==r&&(a["border-radius"]=r);""!==w&&(a.width=w);""!==z&&(a["shadow-size"]=z);r=b.find(".tdc-css-shadow-color");w=r.val().trim();""!==w?a["shadow-color"]=w:(r=r.data("no_value"),d.isUndefined(r)||1!==r||(a["shadow-color"]="no_value"));""!==x&&(a["shadow-offset-h"]=x);""!==A&&(a["shadow-offset-v"]=A);x=b.find(".tdc-css-bg-color");A=x.val().trim();""!==A?a["background-color"]=A:(x=x.data("no_value"),d.isUndefined(x)||1!==x||(a["background-color"]="no_value"));x=b.find(".tdc-css-bg-image");x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
(x=x.data("image_link"),d.isUndefined(x)||("no_value"===x?a["background-image"]="no_value":""!==x&&(a["background-image"]='url("'+x+'")')));x=b.find(".tdc-css-bg-style");A=x.val().trim();""===A||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-style"]=A);x=b.find(".tdc-css-bg-position");A=x.val().trim();""===A||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-position"]=A);""!==y&&(a.opacity=y);y=b.find(".tdc-css-color-1-overlay");
x=y.val().trim();""!==x?a["color-1-overlay"]=x:(y=y.data("no_value"),d.isUndefined(y)||1!==y||(a["color-1-overlay"]="no_value"));y=b.find(".tdc-css-color-2-overlay");x=y.val().trim();""!==x?a["color-2-overlay"]=x:(y=y.data("no_value"),d.isUndefined(y)||1!==y||(a["color-2-overlay"]="no_value"));""!==B&&(a["gradient-direction"]=B);""!==C&&(a["z-index"]=C);B=b.find(".tdc-css-content-h-align");C=B.val().trim();""===C||B.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["content-h-align"]=
C);b=b.find(".tdc-css-display");a.display=b.val().trim();d.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});d.isUndefined(a["border-style"])||"solid"!==a["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||d.isUndefined(tdcCssEditor._currentCssSettings.all)||d.isUndefined(tdcCssEditor._currentCssSettings.all["border-style"]))&&delete a["border-style"];d.isUndefined(a["background-style"])||"cover"!==a["background-style"]||("all"===tdcSidebar.currentViewportSettings.name||
d.isUndefined(tdcCssEditor._currentCssSettings.all)||d.isUndefined(tdcCssEditor._currentCssSettings.all["background-style"]))&&delete a["background-style"];d.isUndefined(a["background-position"])||"center top"!==a["background-position"]||("all"===tdcSidebar.currentViewportSettings.name||d.isUndefined(tdcCssEditor._currentCssSettings.all)||d.isUndefined(tdcCssEditor._currentCssSettings.all["background-position"]))&&delete a["background-position"];tdcDebug.log(a);d.isEmpty(a)?(delete tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name],
...
"_min_width"]=tdcSidebar.currentViewportSettings.settings.limitBottom));tdcDebug.log(tdcCssEditor._currentCssSettings);tdcDebug.log("JSON.stringify");tdcDebug.log(JSON.stringify(tdcCssEditor._currentCssSettings));return d.isEmpty(tdcCssEditor._currentCssSettings)?"":window.btoa(JSON.stringify(tdcCssEditor._currentCssSettings))},_getRgba:function(b){return-1!==b.indexOf("rgb")?b:(b=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(b))?"rgb("+parseInt(b[1],16)+", "+parseInt(b[2],16)+", "+parseInt(b[3],
16)+")":""}}})(jQuery,_);var tdcContextMenu={};
